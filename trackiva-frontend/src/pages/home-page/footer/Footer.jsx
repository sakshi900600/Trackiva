        ...
        <div className={styles.top}>
          <div className={styles.brand}>
            ...
            <div className={styles.socials}>
              <a href="https://x.com/?lang=en" className={styles.socialIcon} aria-label="Follow Trackiva on Twitter">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="https://in.linkedin.com/" className={styles.socialIcon} aria-label="Connect with Trackiva on LinkedIn">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2z"/>
                  <circle cx="4" cy="4" r="2"/>
                </svg>
              </a>
              <a href="https://www.instagram.com" className={styles.socialIcon} aria-label="Follow Trackiva on Instagram">
