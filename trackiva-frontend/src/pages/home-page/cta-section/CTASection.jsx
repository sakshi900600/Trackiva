    ...
    <section className={styles.section}>
      <div className={styles.container}>
        ...
        <p className={styles.subtitle}>
          Stop applying into the void. Start tracking, analyzing, and winning.<br />
        ...
        <div className={styles.actions}>
          <a href="#" className={styles.btnPrimary}>
            ...
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path d="M3 8h10M8.5 4l4.5 4-4.5 4" stroke="white" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </a>
          <a href="#" className={styles.btnGhost}>Watch Demo</a>
        </div>
        ...
        <div className={styles.trustRow}>
          ...
          <span className={styles.trustDot} />
          <span className={styles.trustItem}>✓ Setup in 2 minutes</span>
        </div>
      </div>
    </section>
  );
